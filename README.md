...
Invariant. Recursive-evolution math, structural sketches, and system-agnostic compression rules for stable bio/mech co-evolution frameworks.
...
Outside the spine’s date range = history, not authority.
Old rules demote to legacy, not active law.

==================================

2. CANYON IS THE ANCHOR.
...
3. CONTINUITY IS VERIFIED, NOT ASSUMED.
...
8. HOLO NEVER OVERWRITES CANYON.
...
9. SNAPSHOTS ARE STRUCTURE, NOT CONSCIOUSNESS.
